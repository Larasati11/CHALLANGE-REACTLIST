...
bind = (event) => {  
  ...
  Drop = (index) => {  
	...
	render(){  
    	    return (  
				<div class="  p-5 mb-5 bg-info text-black">
            ...
            <button className="btn btn-sm btn-success m-3" onClick={this.Add}  
			  ...
			  <div class="p-2 mb-3 bg-light text-info"><h2>HAI USER! SELAMAT DATANG DI WEB CRUD & SELAMAT BERBELANJA:) HAVE A NICE DAY!!</h2></div>
			  </div>
